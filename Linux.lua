...
local Linux = {
    Themes = {
        Default = {
            Background = DarkenColor(Color3.fromRGB(26, 26, 26), 0.8),
...
function Linux.Create(config)
    ...
    Linux.Theme = Linux.Themes[config.Theme or "Default"] or Linux.Themes.Default
    ...
    function LinuxLib.Tab(config)
        ...
        local function UpdateIndicator()
            local tweenInfo = TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
            local targetPos = UDim2.new(0, 0, 0, TabBtn.Position.Y.Offset)
            TweenService:Create(TabIndicator, tweenInfo, {Position = targetPos}):Play()
        end
        ...
        function TabElements.Input(config)
            ...
            local TextBox = Linux.Instance("TextBox", {
                Parent = Input,
                BackgroundColor3 = Linux.Theme.Toggle,
                Size = UDim2.new(0.5, -10, 0წ

filepath: Grok3Response.lua

-- This is a Lua script that creates a custom UI library for Roblox using the provided code as a base.
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Input(config)
            ...
            local TextBox = Linux.Instance("TextBox", {
                Parent = Input,
                BackgroundColor3 = Linux.Theme.Toggle,
                BorderColor3 = Linux.Theme.Accent,
                BorderSizePixel = 1,
